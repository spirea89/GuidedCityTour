...
**iOS (City Quest):** native SwiftUI app in [`ios/`](ios/README.md). Pick a map area, turn nearby OSM buildings into a stylized 3D game district, tap a block for the same sourced history pipeline. Open `ios/GuidedCityTour.xcodeproj` in Xcode 15.4+ (iOS 17).
